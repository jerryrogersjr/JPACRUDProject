...
<body>
	...
	<form action="updateCar.do" method="POST">
		...
		<label for="carId">Car Id:</label>
			<input type="text" value="${car.id}" name="carId" disabled="disabled">
		<br>
		<label for="makeModel">Make / Model</label>
			<input type="text" value="${car.makeModel}" name="makeModel">
		<br>
		<label for="mpg">MPG</label>
			<input type="text" value="${car.mpg}" name="mpg">
		<br>
		<label for="cylinders">Cylinders</label>
			<input type="text" value="${car.cylinders}" name="cylinders">
		<br>
		<label for="displacement">Displacement</label>
			<input type="text" value="${car.displacement}" name="displacement">
		<br>
		<label for="horsepower">Horsepower</label>
			<input type="text" value="${car.horsepower}" name="horsepower">
		<br>
		<label for="weight">Weight</label>
			<input type="text" value="${car.weight}" name="weight">
		<br>
		<label for="acceleration">Acceleration</label>
			<input type="text" value="${car.acceleration}" name="accerleration">
		<br>
		<label for="year">Year</label>
			<input type="text" value="${car.year}" name="year">
		<br>
		<label for="origin">Origin</label>
			<input type="text" value="${car.origin}" name="origin">
		<br>
