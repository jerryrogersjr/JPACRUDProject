...
<body>
	<br>
	<div>
		<h2 align="center">Add an Automobile to the List</h2>
		<br>
			...
			<form action="addCar.do" method="POST">
				<div>
					<label for="makeModel">Make and Model</label> <input type="text"
						class="form-control" name="makeModel"
						placeholder="enter make and model" required="required" /><br>
					<label for="mpg">Miles Per Gallon (mpg)</label> <input
						type="number" class="form-control" name="mpg"
						placeholder="enter fuel economy (mpg)" required="required" /><br>
					<label for="cylinders">Total Cylinders</label> <input type="number"
						class="form-control" name="cylinders"
						placeholder="enter engine cyliner total" required="required" /><br>
					<label for="displacement">Displacement</label> <input type="number"
						class="form-control" name="displacement"
						placeholder="enter engine displacement" required="required" /><br>
					<label for="horsepower">Horsepower</label> <input type="number"
						class="form-control" name="horsepower"
					...
					<label for="acceleration">Acceleration</label> <input type="number"
						class="form-control" name="acceleration"
					...
					<label for="year">Year</label> <input type="number"
						...
						required="required" /><br> <label for="origin">Origin</label>
